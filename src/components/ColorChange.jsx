...
export const ColorChange = ({ label }) => {
        ...
        <>
            <div className="card bg-base-100 shadow-md border border-base-300">
                <div className="card-body gap-4">
                    ...
                    <p className="text-sm text-base-content/60">ボタンで円の色を切り替えます。</p>
                    ...
                    <div className="join">
                        <button onClick={() => setBgStatus(0)} className="btn btn-primary join-item">
                            1
                        </button>
                        <button onClick={() => setBgStatus(1)} className="btn btn-secondary join-item">
                            2
                        </button>
                        <button onClick={() => setBgStatus(2)} className="btn btn-accent join-item">
                            3
                        </button>
                        <button onClick={() => setBgStatus(null)} className="btn btn-neutral btn-soft join-item">
                            リセット
                        </button>
                    </div>
                </div>
